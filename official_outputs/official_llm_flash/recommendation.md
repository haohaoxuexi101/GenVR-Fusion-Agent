...
- 指标文件：`G:/ssn_gmc_llmapi/official_outputs/official_llm_flash/experiments/angular_refined/metrics.json`
- 诊断文件：`G:/ssn_gmc_llmapi/official_outputs/official_llm_flash/experiments/angular_refined/diagnostics.json`
- 通量图：`G:/ssn_gmc_llmapi/official_outputs/official_llm_flash/experiments/angular_refined/lattice_stage8_ultra.png`
...
- 指标文件：`G:/ssn_gmc_llmapi/official_outputs/official_llm_flash/experiments/combined_refined/metrics.json`
- 诊断文件：`G:/ssn_gmc_llmapi/official_outputs/official_llm_flash/experiments/combined_refined/diagnostics.json`
- 通量图：`G:/ssn_gmc_llmapi/official_outputs/official_llm_flash/experiments/combined_refined/lattice_stage8_ultra.png`
